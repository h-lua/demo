...
hevent.reaction(CONST_EVENT.avoid, function(evtData)
    heffect.attach("Abilities\\Spells\\Orc\\MirrorImage\\MirrorImageCaster.mdl", evtData.triggerUnit, "origin", 0.5, 1)
end)