...
return {
    ...
    run = function(options)
        ...
        local pxSkx0 = 1279.8115
        local pxSky0 = 573.1227
        local pxIt = 125
        local pxItx = 10.5
        local pxIty = 8.5
        local pxSk = 150
        ...
        local px = {
            ...
            portrait = { w = _x(506.5595), h = _x(447.5005), x = _x(732.1953), y = _y(300) },
        ...
        hdzui.framePoint(demoCache.unitMessage, demoCache.main, FRAME_ALIGN_LEFT_BOTTOM, FRAME_ALIGN_LEFT_TOP, px.minMap.x, -0.01)
        ...
        local moreBtns = { "more_x_up", "more_x_tras", "more_x_oppose", "more_e_attack", "more_e_append", "more_e_oppose" }
        -- 之后下面是自定义UI
        -- 每个周期都更新UI
                        ...
                        for i, _ in ipairs(moreBtns) do
                            ...
                            if (i == 1) then
                                ...
                                if (his.hasSlot(selection)) then
                                    sIn("负重：" .. math.floor(attr.weight_current) .. "/" .. math.floor(attr.weight) .. "Kg")
                                end
        ...
        hdzui.frameSize(demoCache.sign_str, 0.012, 0.016)
        hdzui.frameSize(demoCache.sign_agi, 0.012, 0.016)
        hdzui.frameSize(demoCache.sign_int, 0.012, 0.016)
        hdzui.frameSize(demoCache.sign_nor, 0.012, 0.016)
        hdzui.framePoint(demoCache.sign_str, demoCache.main, FRAME_ALIGN_LEFT_TOP, FRAME_ALIGN_LEFT_TOP, px.name.x + 0.0024, px.name.y + 0.001)
        ...
        hdzui.framePoint(demoCache.unit_name, demoCache.sign_nor, FRAME_ALIGN_LEFT, FRAME_ALIGN_RIGHT, 0.001, 0)
        -- 英雄名称
